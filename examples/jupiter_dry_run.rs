...
async fn main() -> Result<()> {
    tracing_subscriber::fmt()
        .with_env_filter(EnvFilter::new("polar_bear_rig_hft=info"))
        .init();
    ...
    let swap = polar_bear_rig_hft::onchain::jupiter::simulate_swap(&route, 1.0, true).await?;
    ...
    polar_bear_rig_hft::avm::audit_log(&route, &swap)?;
